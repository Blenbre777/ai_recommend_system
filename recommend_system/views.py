...
def recommend_form(request):
    ...
    # http://localhost:8000/recommend_system/recommend_form?memberno=1

    # Spring Boot -> <a href="http://localhost:8000/recommend_system/recommend_form?memberno=1">추천받기</a> -> Django
